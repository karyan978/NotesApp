A modern, clean and lightweight Notes Application built using React Native with Expo.
Designed for simplicity, speed, and a smooth user experience on Android devices.

📥 Direct APK Download (Production Build)
🔽 Download & Install (No Expo Go Required)
...
✔️ Direct download
✔️ Install like normal Android app
✔️ No Expo Go needed
✔️ Tested build
...
🚀 React Native + Expo Setup Commands
📦 Create Expo Project
```
...
You can sponsor or collaborate via GitHub.
